...
export function OrderForm({ tables, products, modifiers }: Props) {
      ...
      <FieldGroup>
        ...
        <div>
          <div className="mb-2 flex items-center justify-between">
            <FieldLegend variant="label">Ítems</FieldLegend>
            <Button
              type="button"
              variant="outline"
              size="sm"
        ...
        <div className="flex gap-3 pt-2">
          ...
          <Button variant="ghost" size="lg" nativeButton={false} render={<Link href="/admin/orders" />}>
            Cancelar
          </Button>
        </div>
      </FieldGroup>
